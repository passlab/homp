...
REAL sort_ompacc_mdev(int *bufferInt) {
    ...
    if (sort_mdev_v == 3) {
        ...
        omp_data_map_dist_init_info(__bufferInt_map_info__, 0, OMP_DIST_POLICY_BLOCK, 0, NUMBERS, 0, 0);
        ...
        omp_loop_dist_init_info(__off_info__, 0, OMP_DIST_POLICY_MODEL_1_AUTO, 0, NUMBERS, 0, 0);
        ...
        omp_data_map_dist_init_info(__bufferInt_map_info__, 0, OMP_DIST_POLICY_BLOCK, 0, NUMBERS, 0, 0);
        omp_loop_dist_init_info(__off_info__, 0, OMP_DIST_POLICY_BLOCK, 0, NUMBERS, 0, 0);
    }
#if DEBUG_MSG
