...
#ifndef MSIZE
#warning "MSIZE default to be 128"
#define MSIZE 128
#endif
...
*****************************************************************/
#if 1
__global__ void OUT__1__10117__(int n,int m,float omega,float ax,float ay,float b,float *_dev_per_block_error,float *_dev_u,float *_dev_f,float *_dev_uold)
{
  int _p_i;
  int _p_j;
  float _p_error;
...
#if 0
__global__ void OUT__2__10117__(int n,int m,float *_dev_u,float *_dev_uold)
{ 
  int _p_j;
  int _dev_i ;
  long _dev_lower, _dev_upper;
...
/* Launch CUDA kernel ... */
      ...
      OUT__2__10117__<<<_num_blocks_,_threads_per_block_>>>(n,m,_dev_u,_dev_uold);
...
/* Launch CUDA kernel ... */
      ...
      OUT__1__10117__<<<_num_blocks_,_threads_per_block_,(_threads_per_block_ * sizeof(float ))>>>(n,m,omega,ax,ay,b,_dev_per_block_error,_dev_u,_dev_f,_dev_uold);
