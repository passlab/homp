...
__device__ void XOMP_cuda_loop_default_internal(long lower, long upper, long stride, int _p_num_threads, int _p_thread_id, long* n_lower, long* n_upper)
{
  long _p_lower;
  long _p_upper;
  long _p_chunk_size;
...
*/
__device__ void XOMP_accelerator_loop_default(long lower, long upper, long stride, long* n_lower, long* n_upper)
{
...
*/
__device__ void XOMP_static_sched_init(long lb, long up, long step, long orig_chunk_size, int _p_num_threads, int _p_thread_id, \
              long * loop_chunk_size, long * loop_sched_index, long * loop_stride)
{   
...
*/
__device__ long XOMP_static_sched_next(
    long* loop_sched_index , long loop_end, long orig_step, long loop_stride, long loop_chunk_size,
